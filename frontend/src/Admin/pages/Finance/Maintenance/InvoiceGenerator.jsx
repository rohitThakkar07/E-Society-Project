...
const InvoiceGenerator = () => {
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(20).setTextColor(30, 58, 138).text(societyConfig.name.toUpperCase(), 14, 20);
    ...
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center font-sans">
      ...
      <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 max-w-xl w-full overflow-hidden">
        ...
        <div className="p-8">
          ...
          <p className="text-center text-[10px] text-gray-400 mt-6 uppercase tracking-widest">Generated by {societyConfig.name} System</p>
        </div>
      </div>
    </div>
  );
